...
CREATE TABLE `shipment_branch_logs` (
    ...
    `status` VARCHAR(191) NOT NULL,
    `description` VARCHAR(191) NULL,
    `scanned_by_user_id` INTEGER NULL,
...
-- AddForeignKey
ALTER TABLE `shipment_branch_logs` ADD CONSTRAINT `shipment_branch_logs_scanned_by_user_id_fkey` FOREIGN KEY (`scanned_by_user_id`) REFERENCES `users`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
